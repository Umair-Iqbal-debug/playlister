...
function PlayerControls({player,handleNext,handlePrev,toggleShuffle,shuffle}) {
    ...
    let shuffleBtn = (<Button variant='text' onClick={toggleShuffle}>
    <ShuffleRoundedIcon style={style}/>
</Button>)
    if(shuffle) shuffleBtn =(
